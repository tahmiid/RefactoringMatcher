...
appendArray(final Object lhs, final Object rhs, final Comparator<?> comparator) {
...
wrap(final String str, int wrapLength, String newLineStr, final boolean wrapLongWords, String wrapOn) {
        if (str == null) {
            return null;
        }
        if (newLineStr == null) {
...
appendArray(final Object object) {
        // 'Switch' on type of array, to dispatch to the correct handler
...
invokeMethod(final Object object, final boolean forceAccess, final String methodName,
...
replace(String text, String searchString, String replacement, int max, boolean ignoreCase) {
...
appendArray(final Object lhs, final Object rhs) {
...
format(final long millis, final B buf) {
        return printer.format(millis, buf);
    }
format(final Date date, final B buf) {
        return printer.format(date, buf);
    }
format(final Calendar calendar, final B buf) {
        return printer.format(calendar, buf);
    }
addListener(final L listener, boolean allowDuplicate) {
...
createJuneTestDate(final TimeZone timeZone) {
...
checkParse(final Locale locale, final SimpleDateFormat sdf, final DateParser fdf, final String formattedDate) throws ParseException {
		final Date expectedTime = sdf.parse(formattedDate);
        final Date actualTime = fdf.parse(formattedDate);
        assertEquals(locale.toString()+" "+formattedDate +"\n",expectedTime, actualTime);
	}
removeFinalModifier(Field field, boolean forceAccess) {
...
getEraStart(int year, TimeZone zone, Locale locale) {
...
validateSdfFormatFdpParseEquality(String format, Locale locale, TimeZone tz, DateParser fdp, Date in, int year, Date cs) throws ParseException {
...
reverse(final char[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
reverse(final double[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
reverse(final float[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
reverse(final int[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
reverse(final long[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
reverse(final Object[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
reverse(final short[] array, int startIndexInclusive, int endIndexExclusive) {
        if (array == null) {
            return;
        }
        int i = startIndexInclusive < 0 ? 0 : startIndexInclusive;
...
getLocaleSpecificStrategy(int field, Calendar definingCalendar) {
...
processBitVectors(Class<E> enumClass, long... values) {
...
getPatternForStyle(Integer dateStyle, Integer timeStyle, Locale locale) {
...
substring(CharSequence str, int start) {
        if (str == null) {
            return null;
        }
...
substring(CharSequence str, int start, int end) {
        if (str == null) {
            return null;
        }
...
isOSMatch(String osName, String osVersion, String osNamePrefix, String osVersionPrefix) {
...
parseDateWithLeniency(String str, String[] parsePatterns,
...
appendSeparator(String standard, String defaultIfEmpty) {
...
getAllInterfaces(Class<?> cls, HashSet<Class<?>> interfacesFound) {
        while (cls != null) {
...
splitByWholeSeparatorWorker( String str, String separator, 
...
doAssertions(Format format, Object[] args,
...
doUnescape(Writer writer, String string, int firstAmp) throws IOException {
...
testSimpleReflectionObjectCycle() throws Exception {
...
testSelfInstanceVarReflectionObjectCycle() throws Exception {
        SelfInstanceVarReflectionTestFixture test = new SelfInstanceVarReflectionTestFixture();
        assertTrue(ToStringStyle.getRegistry().isEmpty());
        assertEquals(this.toBaseString(test) + "[typeIsSelf=" + this.toBaseString(test) + "]", test.toString());
        this.validateEmptyToStringStyleRegistry();
    }
testSelfInstanceTwoVarsReflectionObjectCycle() throws Exception {
        SelfInstanceTwoVarsReflectionTestFixture test = new SelfInstanceTwoVarsReflectionTestFixture();
        assertTrue(ToStringStyle.getRegistry().isEmpty());
        assertEquals(this.toBaseString(test) + "[typeIsSelf=" + this.toBaseString(test) + ",otherType=" + test.getOtherType().toString() + "]", test.toString());
        this.validateEmptyToStringStyleRegistry();
    }
assertEqualDuration(String message, String expected, int[] start, int[] end, String format) {
...
getNameInOtherClassLoader(Object other) {
        try {
...
cloneReset() throws CloneNotSupportedException {
...
doTestEscapeNamedEntity(final String expected, final String entity) throws Exception
    {
...
doTestUnescapeEntity(final String expected, final String entity) throws Exception
    {
...
readWithQuotes(char[] chars, int start, int len, StrBuilder workArea, List tokens, int quoteStart, int quoteLen) {
...
doReplace(char[] data, int offset, int length, Object ref, List priorVariables) {
        if (data == null) {
            return null;
        }
...
indexOf(Throwable throwable, Class type, int fromIndex, boolean subclass) {
...
format(long millis, String format, boolean padWithZeros, TimeZone timezone) {
...
uncapitalizeAllWords(String str) {
        int strLen;
        if (str == null || (strLen = str.length()) == 0) {
            return str;
        }
...
init(String name, Class enumClass) {
...
testCreateFloatFailure(String str) {
        try {
...
testCreateDoubleFailure(String str) {
        try {
...
testCreateIntegerFailure(String str) {
        try {
...
testCreateLongFailure(String str) {
        try {
...
testCreateBigIntegerFailure(String str) {
        try {
...
testCreateBigDecimalFailure(String str) {
        try {
...
innerTestSplit(char separator, String sepStr, char noMatch) {
        try {
...
lastIndexOf(final long[] array, final long valueToFind, int startIndex) {
        if (array == null) {
            return -1;
        }
        if (startIndex < 0) {
...
checkSomeIntMap(Entities.IntMap map) {
        map.add("foo", 1);
...
assertUnescapeJava(String message, String unescaped, String original) throws IOException {
...
modify(String str, String[] set, boolean expect) {
...
random(int count, int start, int end, boolean letters, boolean numbers, char[] set, Random random) {
        if( (start == 0) && (end == 0) ) {
            end = (int)'z';
            start = (int)' ';
            if(!letters && !numbers) {
...
reflectionCompare(Object lhs, Object rhs, boolean testTransients, Class reflectUpToClass) {
        if (lhs == rhs) {
            return 0;
        }
        if (lhs == null || rhs == null) {
...
getCause(Throwable t, String[] methodNames)
    {
...
getCauseUsingMethodName(String methodName,
                                                     Throwable t)
    {
        Method method = null;
        try
