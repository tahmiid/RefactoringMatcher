	...
	protected void processVariablesWithoutBindingInfo(List<Expression> variableInstructions,
		...
		for (Expression variableInstruction : variableInstructions) {
			...
			if (simpleName.isDeclaration()) {
				...
				Set<PostfixExpression> localVariablePostfixAssignments = getMatchingPostfixAssignments(simpleName,
						postfixExpressions);
				Set<PrefixExpression> localVariablePrefixAssignments = getMatchingPrefixAssignments(simpleName,
						prefixExpressions);
